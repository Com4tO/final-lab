...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            {'label': 'Recession Peroid Statistics', 'value': 'Recession Period Statistics'}],
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        average_sales = recession_data.groupby('Vehicle_Type')['Automobie_Sales'].mean().reset_index()                 
        R_chart2  = dcc.Graph(
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
         # grouping data for plotting.
         # Hint:Use the columns Year and Automobile_Sales
        avr_vdata=yearly_data.grougby('Year')['Automobile_Sales'].mean().reset_index()
